...
const samplePosts = [
  ...
  },
  {
    ...
    timestamp: "3 years ago",
    content:
      "All in the world know the beauty of the beautiful, and in doing this they have (the idea of) what ugliness is; they all know the skill of the skilful, and in doing this they have (the idea of) what the want of skill is. So it is that existence and nonexistence give birth the one to (the idea of) the other; that difficulty and ease produce the one (the idea of) the other.",
    quote:
      "The work is done, but how no one can see; This that makes the power not cease to be.",
    likes: 0,
  },
  {
    author: "Admin",
    ...
    timestamp: "3 years ago",
    content:
      "Not finding an explanation in science I began to seek for it in life, hoping to find it among the people around me. And I began to observe how the people around me lived, and what their attitude was to this question which had brought me to despair.",
    likes: 0,
  },
  {
    author: "Admin",
